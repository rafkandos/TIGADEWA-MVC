...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url('<?=base_url()?>assets/images/mount5a.jpg');" data-aos="fade" data-stellar-background-ratio="0.5" data-aos="fade">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-8 text-center" data-aos="fade-up" data-aos-delay="200">
            <h1 class="mb-4" style="color: #fe6700; font-weight: bold;">CONTACT US</h1>
    ...
    <div class="site-section">
      <div class="container">
        <img src="<?=base_url()?>assets/images/tigadewa.jpg" class="images img-fluid">
        <div class="row mt-5">
          <div class="site-section-heading mt-4 w-border col-md-12 col-lg-6 mx-auto" data-aos="fade-up">
            <h2 class="mb-4">Adress</h2>
            <h5>Jalan Merpati Timur RT 09 RW 09 No. 31 <br> Pedurungan Tengah Semarang</h5>
          </div>
          <div class=" site-section-heading mt-4 w-border col-md-12 col-lg-6 mx-auto" data-aos="fade-up">
            <h2 class="mb-4">WhatsApp</h2>
            <h5>0821-4118-5741</h5>
            <h5>0813-3772-7343</h5>
          </div>
        </div>
        <div class="row mt-5">
          <div class="site-section-heading mt-4 w-border col-md-12 col-lg-6 mx-auto" data-aos="fade-up">
            <h2 class="mb-4">Instagram</h2>
            <h5>Official <a target="_blank" href="https://www.instagram.com/tigadewaadventureindonesia/" style="color: #fe6700">@tigadewaadventureindonesia</a></h5>
          </div>
          <div class=" site-section-heading mt-4 w-border col-md-12 col-lg-6 mx-auto" data-aos="fade-up">
            <h2 class="mb-4">Email</h2>
            <h5>tigadewaadventureindonesia@gmail.com</h5>
          </div>
        </div>
        <div class="row mt-5">
          <div class="site-section-heading mt-4 w-border col-md-12 mx-auto" data-aos="fade-up">
            <h2 class="mb-4">Transfer</h2>
            <h5>Bank BRI : <span style="color: #fe6700">1451-01-000764-53-5</span></h5>
            <h5>Bank Mandiri : <span style="color: #fe6700">135-00-1504158-3</span></h5>
            <h5>Bank BNI Syariah : <span style="color: #fe6700">06-8665-6552</span></h5>
            <h5>Bank BCA : <span style="color: #fe6700">854-531-9639</span></h5>
            <h5>Atas Nama <span style="color: #fe6700">Muhammad Rifqi Maulana</span></h5>
          </div>
          </div>
        </div>
      </div>
