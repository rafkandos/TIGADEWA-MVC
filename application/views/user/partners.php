    ...
    <<div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mt-3">
            <img src="<?=base_url()?>assets/images/centerpole.jpg" class="images img-fluid">
          </div>
          <div class="col-md-6 col-lg-4 mt-3">
            <img src="<?=base_url()?>assets/images/coleman.jpg" class="images img-fluid">
          </div>
          <div class="col-md-6 col-lg-4 mt-3">
            <img src="<?=base_url()?>assets/images/karrimor.jpg" class="images img-fluid">
          </div>
          <div class="col-md-6 col-lg-4 mt-3">
