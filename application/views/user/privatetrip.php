    ...
    <div class="site-wrap">
        ...
        <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url('<?=base_url()?>assets/images/mount2.jpg');"
            data-aos="fade" data-stellar-background-ratio="0.5" data-aos="fade">
        <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-8 text-center" data-aos="fade-up" data-aos-delay="400">
            <h1 class="mb-4" style="color: #fe6700; font-weight: bold;">Trip &amp; Events</h1>
    ...
    <div class="site-section" style="margin-top: -20px;">
        ...
        <div id="openItem" style="display: block;">
            <div class="row mt-5">
            <div class="site-section-heading text-center mb-5 w-border col-md-6 mx-auto">
                <h2 class="mb-5">It's Private Trip</h2>
                    ...
                    foreach ($privatetrip as $o) {
                        echo '
                            <div class="col-md-6 col-lg-4 mb-3 mb-lg-5">
                                <div class="team-2one">
                                    <a href="'.base_url('index.php/PrivateTrip/Detail/'.$o->id_privatetrip).'">
