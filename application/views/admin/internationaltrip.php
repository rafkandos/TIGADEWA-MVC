...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">International Trip</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)" style="color: #fe6700">TDA Indonesia</a></li>
                            <li class="breadcrumb-item active">International Trip</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <h4 class="card-title text-uppercase">International Trip</h4>
                                    </div>
                                    <div class="col-md-6">
                                                ...
                                                foreach ($internationaltrip as $o ) {
                                                    ...
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <a onclick="edit('.$o->id_internationaltrip.')" href="#" 
                                                                    data-toggle="modal" data-target="#update" 
                                                                    class="m-t-5 waves-effect waves-dark btn btn-primary">
                                                                    <i class="mdi mdi-grease-pencil"></i> Edit
                                                                </a>
                                                                <a href="'.base_url('index.php/_internationaltrip/delete/'.$o->id_internationaltrip).'" onclick="return confirm(\'Apakah anda yakin untuk menghapus '.$o->ItripName.'\')"
                                                                    class="m-t-5 waves-effect waves-light btn btn-danger">
                                                                    <i class="mdi mdi-delete"></i> Delete
                                                                </a>
                                                                <a onclick="upload('.$o->id_internationaltrip.')" href="#" 
                                                    ...
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="'.base_url('index.php/_internationaltrip/deletemp/'.$m->id_pricing).'" onclick="return confirm(\'Apakah anda yakin untuk menghapus '.$m->meetingPoint.'\')"
                                                                    class="m-t-5 waves-effect waves-light btn btn-danger">
                                                                    <i class="mdi mdi-delete"></i> Delete
                                                                </a>
                                                            </td>
                                                    ...
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <a href="'.base_url('index.php/_internationaltrip/deletesch/'.$m->id_schedule).'" onclick="return confirm(\'Apakah anda yakin untuk menghapus '.$m->scheduleDate.'\')"
                                                                    class="m-t-5 waves-effect waves-light btn btn-danger">
                                                                    <i class="mdi mdi-delete"></i> Delete
                                                                </a>
                                                            </td>
    ...
    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php base_url()?>_internationaltrip/add" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-block">
                                    <div class="form-horizontal form-material form-group">
                                        <input type="hidden" name="id_internationaltrip">
    ...
    <div class="modal fade" id="addmp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php base_url()?>_internationaltrip/addmp" method="post">
                    <div class="modal-body">
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-block">
                                    <div class="form-horizontal form-material form-group">
                                        ...
                                        <select name="tn" class="form-control form-control-line">
                                            <?php 
                                                foreach ($internationaltrip as $o) {
                                                    echo '
                                                        <option value="'.$o->id_internationaltrip.'">'.$o->ItripName.'</option>
                                                    ';
                                                }
                                            ?>
                                        </select>
    ...
    <div class="modal fade" id="addsch" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php base_url()?>_internationaltrip/addsch" method="post">
                    <div class="modal-body">
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-block">
                                    <div class="form-horizontal form-material form-group">
    ...
    <div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php base_url()?>_internationaltrip/update" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-block">
                                    <div class="form-horizontal form-material form-group">
                                        <input type="hidden" name="id_internationaltrip" id="id_internationaltrip">
                                        <label class="font-weight-bold">TripName</label>
    ...
    <div class="modal fade" id="updatemp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php base_url()?>_internationaltrip/updatemp" method="post">
                    <div class="modal-body">
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-block">
                                    <div class="form-horizontal form-material form-group">
    ...
    <div class="modal fade" id="updatesch" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php base_url()?>_internationaltrip/updatesch" method="post">
                    <div class="modal-body">
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-block">
                                    <div class="form-horizontal form-material form-group">
    ...
    <div class="modal fade" id="upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	        <div class="modal-dialog" role="document">
	            <div class="modal-content">
	                ...
	                <form action="<?php base_url()?>_internationaltrip/upload" method="post" enctype="multipart/form-data">
	                    <div class="modal-body">
	                        <div class="tab-pane" id="settings" role="tabpanel">
	                            <div class="card-block">
	                                    <div class="form-horizontal form-material form-group">
    ...
    <script type="text/javascript">
        ...
        function upload(id_internationaltrip){
            $("#id_reg").val(id_internationaltrip);
        }

        //internationaltrip
        function edit(id) {
            $('#id_internationaltrip').val();
            $('#ov').val();
            $('#pre').val();
            $('#tn').val();
            $('#ic').val();
        ...
        function editmp(id) {
            ...
            $.getJSON("<?php echo base_url('index.php/_internationaltrip/get_id_pr/') ?>"+ id, function(data){
        ...
        function editsch(id) {
            ...
            $.getJSON("<?php echo base_url('index.php/_internationaltrip/get_id_sch/') ?>"+ id, function(data){
                $('#id_schedule').val(data.id_schedule);
                $('#tnsch').val(data.it_id);
