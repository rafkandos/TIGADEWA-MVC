...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Merchantdise</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)" style="color: #fe6700">TDA Indonesia</a></li>
                            <li class="breadcrumb-item active">Merchantdise</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered" id="dtTables">
                                        ...
                                        <tbody>
                                            <?php
                                                foreach ($merchant as $o ) {
                                                    echo '
                                                        <tr>
                                                            <td>'.$o->id_merchantdise.'</td>
                                                            <td>'.$o->name.'</td>
                                                            <td align="center"><img src="'.base_url('assets/uploads/'.$o->photo).'" style="width: 70px;" alt="img"></td>
                                                            
                                                            <td align="center">
                                                                <a onclick="edit('.$o->id_merchantdise.')" href="#" 
                                                                    data-toggle="modal" data-target="#update" 
                                                                    class="m-t-5 waves-effect waves-dark btn btn-primary">
                                                                    <i class="mdi mdi-grease-pencil"></i> Edit
                                                                </a>
                                                                <a href="'.base_url('index.php/_merchantdise/delete/'.$o->id_merchantdise).'" onclick="return confirm(\'Apakah anda yakin untuk menghapus '.$o->name.'\')"
                                                                    class="m-t-5 waves-effect waves-light btn btn-danger">
                                                                    <i class="mdi mdi-delete"></i> Delete
                                                                </a>
                                                                <a onclick="upload('.$o->id_merchantdise.')" href="#" 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="exampleModalLabel">Add Merchantdise</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?php base_url()?>_merchantdise/add" method="post">
                    <div class="modal-body">
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-block">
                                    <div class="form-horizontal form-material form-group">
                                        <!-- <input type="hidden" name="id_opentrip"> -->
                                        <label class="font-weight-bold">Merchantdise Name</label>
                                        <input type="text" class="form-control form-control-line" name="mn">
                                        <br><br>
                                    </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Merchantdise</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?php base_url()?>_merchantdise/update" method="post">
                    <div class="modal-body">
                        <div class="tab-pane" id="settings" role="tabpanel">
                            <div class="card-block">
                                    <div class="form-horizontal form-material form-group">
                                        <input type="hidden" name="id_merchantdise" id="id_merchantdise">
                                        <label class="font-weight-bold">Merchantdise Name</label>
                                        <input type="text" class="form-control form-control-line" name="mn" id="mn">
                                        <br><br>
                                    </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	        <div class="modal-dialog" role="document">
	            <div class="modal-content">
	                ...
	                <form action="<?php base_url()?>_merchantdise/upload" method="post" enctype="multipart/form-data">
	                    <div class="modal-body">
	                        <div class="tab-pane" id="settings" role="tabpanel">
	                            <div class="card-block">
	                                    <div class="form-horizontal form-material form-group">
    ...
    <script type="text/javascript">
        ...
        function upload(id_merchantdise){
            $("#id_reg").val(id_merchantdise);
        }
        ...
        function edit(id) {
            ...
            $.getJSON("<?php echo base_url('index.php/_merchantdise/get_id_ot/') ?>"+ id, function(data){
                $('#id_merchantdise').val(data.id_merchantdise);
                $('#mn').val(data.name);
            });
        }
