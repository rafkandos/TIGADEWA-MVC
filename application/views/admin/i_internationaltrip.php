            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav active">
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a class="waves-effect waves-dark active" href="<?=base_url()?>index.php/_internationaltrip" aria-expanded="false">    <i class="mdi mdi-earth"></i>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <form method="post" action="<?=base_url()?>index.php/_internationaltrip/addit" class="form-horizontal form-material">
